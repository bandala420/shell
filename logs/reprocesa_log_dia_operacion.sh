#!/bin/bash
#borra un dia y lo reprocesa PARA TODOS LOS RESTAURANTES 
#DE UNA FRANQUICIA
...
#
#
#./reprocesa_dias.sh 2020-12-12 mcd_grill
...
if [ -d "$home" ];
then
echo "Iniciando para Todos los restaurantes en: $home"
...
#5 = pass
	...
	then
        ...
        echo "ALGO OCURRIO ARCHIVO VACIO: $1/$2  TAMANO= $tamano_subir"
        fi
}
...
for d in $directorio_logs/* ; do
	...
	pos_num=${POS//[!0-9]/}
        origen=$directorio_logs/$POS/$anio-$mes
			...
			echo "No se encontro en: $origen/$archivo"
...
echo "$home No existe o no es una ruta de franquicia valida..."
fi;
